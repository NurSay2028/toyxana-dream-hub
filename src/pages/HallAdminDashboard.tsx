...
import { UtensilsCrossed, Music, Heart, QrCode, Image } from 'lucide-react';
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background">
        <div className="glass rounded-lg p-8 text-center max-w-md">
          ...
          <p className="text-muted-foreground mb-4">Sizdiń akkauntıńız hesh bir toyxonańa baylanısqan emes. Super admin sizdi tayınlawı kerek.</p>
